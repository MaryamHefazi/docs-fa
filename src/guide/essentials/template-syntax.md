...
:::tip راهنمایی
توابعی که داخل عبارات binding فراخوانی شده اند، هر دفعه که کامپوننت آپدیت می‌شود فراخوانی می‌شوند، بنابراین آنها **نباید** هیچ اثر جانبی داشته باشد، مانند تغییر داده ها یا شروع عملیات ناهمزمان.
:::
